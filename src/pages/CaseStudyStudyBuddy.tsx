            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {steps.map((step) => (
                <div key={step.num} className="flex flex-col items-center">
                  ...
                  <div className={`rounded-lg overflow-hidden w-full bg-muted/30 ${step.num <= 2 ? 'flex items-start justify-center' : ''}`}>
                    <img
                      src={step.img}
                      alt={step.caption}
                      className={step.num <= 2 ? 'w-[260px] h-auto' : 'w-full h-[400px] object-contain'}
                    />
                  </div>
